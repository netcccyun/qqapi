...
class PdoHelper
{
	...
	private function _select($table, $fields = '*', $where = array(), $sort = null, $limit = null){
		...
		$sql = ' FROM '.$this->prefix.$table.$conditions["_where"];
		if(is_array($limit)){
	...
	public function insert($table, $data){
		...
		$rowCount = $this->exec("INSERT INTO ".$this->prefix.$table." (".implode(', ', $keys).") VALUES (".implode(', ', $marks).")", $values);
		if($rowCount){
	...
	public function update($table, $data, $where){
		...
		$conditions = $this->_where($where);
		$rowCount = $this->exec("UPDATE ".$this->prefix.$table." SET ".$update.$conditions["_where"], $conditions["_bindParams"] + $values);
		return $rowCount;
	}
	...
	public function delete($table, $where){
		$conditions = $this->_where($where);
		$rowCount = $this->exec("DELETE FROM ".$this->prefix.$table.$conditions["_where"], $conditions["_bindParams"]);
		return $rowCount;
	}
	...
	public function count($table, $where){
		$conditions = $this->_where($where);
		$count = $this->getColumn("SELECT COUNT(*) FROM ".$this->prefix.$table.$conditions["_where"], $conditions["_bindParams"]);
		return $count;
	}
